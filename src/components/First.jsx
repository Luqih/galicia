                    ...
                    <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-no-line">
                      <div className="row margin-top-negative-50-desktop">
                        <div className="col-xs-12 col-sm-4">
                          ...
                          <label id="Nombre-error" className="mensaje-error" textcontent="El nombre es inválido" htmlFor="Nombre" style={{ display: 'none' }}>
...
La fecha es inválida
                        ...
                        <div className="col-xs-12 col-sm-4 col-lg-4">
                          ...
                          <label id="Documento-error" className="mensaje-error" textcontent="El apellido es inválido" htmlFor="Documento" style={{ display: 'none' }}>
                            <i className="fa fa-exclamation-circle" />
                            {' '}
