...
export default class Pyme extends React.Component {
  state = {
        ...
        <div className="contenedor-banner-landing">
          <div className="banner-landing">
            <div className="container padding-left-none">
              <h5 className="hidden-xs" style={{ color: 'white' }}>
Conocé tus alternativas
                {' '}
                <br />
                {' '}
ahora y empezá a soñar
              </h5>
              <h5 className="hidden-sm hidden-md hidden-lg" style={{ color: 'white' }}>
Tu financiamiento
                {' '}
                <br />
Galicia ahora
              </h5>
              <p className="hidden-xs" style={{ color: 'white' }}>
Consulta 100% online!
                {' '}
                <span className="numerito" style={{ color: 'white' }} />
              </p>
              <p className="hidden-sm hidden-md hidden-lg" style={{ color: 'white' }}>
Consulta 100% online!
                {' '}
...
en créditos y tarjetas.
        ...
        <form action="https://sacatutarjeta.bancogalicia.com.ar/landing/confirmar" id="FormIngresoDos" method="post">
          {' '}
          {/* Page Content */}
                  ...
                  <div className="col-xs-12">
                    <h1 className="page-title">
                      <i className="fa fa-angle-right" />
                            Conoce tus opciones, es así de fácil
                    </h1>
                  </div>
          ...
          <div className="row margin-top-negative-50-desktop">
            <div className="col-xs-12 col-sm-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  <input data-name="El nombre" name="Nombre" maxLength={30} type="text" id="Nombre" data-gtm="Nombre" className="form-control incompleto initial-form hidden-control alpha_spaces_enie_initialForm" errmsg="El nombre es incorrecto." autoComplete="off" validatewith="validarCampos" />
                  <label htmlFor="password" className="inputLabel">Nombre</label>
                  <div className="inputUnderline" />
                </div>
              </div>
              <label id="Nombre-error" className="mensaje-error" textcontent="El nombre es inválido" htmlFor="Nombre" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El nombre es inválido</label>
            </div>
            <div className="col-xs-12 col-sm-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  <input name="cuit" data-name="La fecha" pattern="[0-9]*" maxLength={11} autoComplete="off" type="tel" id="Documento" className="initial-form incompleto form-control hidden-control numbersDots" errmsg="El número de documento es incorrecto. Ingrese solo números." validatewith="validarCampos" />
                  <input className="initial-form hidden" data-gtm="Dni" id="Dni" name="cuit" type="hidden" validatewith="validarCampos" defaultValue />
                  <label htmlFor="password" className="inputLabel">CUIT</label>
                </div>
              </div>
              <label id="Apellido-error" className="mensaje-error" textcontent="El apellido es inválido" htmlFor="Apellido" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El apellido es inválido</label>
            </div>
            <div className="clearfix" />
            <div className="col-xs-12 col-sm-4 col-lg-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  <input data-name="El nombre" name="direccion" maxLength={30} type="text" id="Nombre" data-gtm="Nombre" className="form-control incompleto initial-form hidden-control alpha_spaces_enie_initialForm" errmsg="El nombre es incorrecto." autoComplete="off" validatewith="validarCampos" />
                  <label htmlFor="password" className="inputLabel">Nombre</label>
                  <div className="inputUnderline" />
                  <div className="inputUnderline" />
                </div>
              </div>
              <label id="Documento-error" className="mensaje-error" textcontent="El apellido es inválido" htmlFor="Documento" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El documento es inválido</label>
            </div>
            <div className="clearfix" />
            <div className="col-xs-12 col-sm-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  <input data-name="El nombre" name="Nombre" maxLength={30} type="text" id="Nombre" data-gtm="Nombre" className="form-control incompleto initial-form hidden-control alpha_spaces_enie_initialForm" errmsg="El nombre es incorrecto." autoComplete="off" validatewith="validarCampos" />
                  <label htmlFor="password" className="inputLabel">Calle</label>
                  <div className="inputUnderline" />
                </div>
              </div>
              <label id="Nombre-error" className="mensaje-error" textcontent="El nombre es inválido" htmlFor="Nombre" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El nombre es inválido</label>
            ...
            <div className="col-xs-12 col-sm-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  ...
                  <label htmlFor="password" className="inputLabel">Altura</label>
                  <div className="inputUnderline" />
                </div>
              </div>
              <label id="Apellido-error" className="mensaje-error" textcontent="El apellido es inválido" htmlFor="Apellido" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El apellido es inválido</label>
            ...
            <div className="col-xs-12 col-sm-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  <input data-name="El nombre" name="Nombre" maxLength={30} type="text" id="Nombre" data-gtm="Nombre" className="form-control incompleto initial-form hidden-control alpha_spaces_enie_initialForm" errmsg="El nombre es incorrecto." autoComplete="off" validatewith="validarCampos" />
                  <label htmlFor="password" className="inputLabel">Provincia</label>
                  <div className="inputUnderline" />
                </div>
              </div>
              <label id="Nombre-error" className="mensaje-error" textcontent="El nombre es inválido" htmlFor="Nombre" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El nombre es inválido</label>
            ...
            <div className="col-xs-12 col-sm-4">
              <div className="inputWrapper">
                <div className="inputArea">
                  <input data-name="El apellido" maxLength={30} name="Apellido" type="text" id="Apellido" data-gtm="Apellido" className="form-control initial-form hidden-control alpha_spaces_enie_initialForm incompleto" errmsg="El apellido es incorrecto." autoComplete="off" validatewith="validarCampos" />
                  <label htmlFor="password" className="inputLabel">Ciudad</label>
                  <div className="inputUnderline" />
                </div>
              </div>
              <label id="Apellido-error" className="mensaje-error" textcontent="El apellido es inválido" htmlFor="Apellido" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El apellido es inválido</label>
                ...
                <div className="col-xs-12 col-sm-4 col-lg-4">
                  <div className="inputWrapper">
                    <div className="inputArea">
                      ...
                      <label htmlFor="password" className="inputLabel">Mail Empresa</label>
                      <div className="inputUnderline" />
                    </div>
                  </div>
                  <label id="Email-error" className="mensaje-error" textcontent="El apellido es inválido" htmlFor="Email" style={{display: 'none'}}><i className="fa fa-exclamation-circle" /> El mail es inválido</label>
                </div>
                <div className="clearfix" />
                <div className="clearfix" />
              </div>
...
.
                  ...
                  <div className="col-xs-12 col-sm-12 col-md-9 col-md-offset-3 col-lg-10 col-lg-offset-3">
                    <input
                      type="button"
                      className="btn btn-md margin-bottom-60"
