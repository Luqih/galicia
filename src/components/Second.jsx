    ...
    <StyledSecond>
      <div>
          ...
          <nav className="navbar navbar-inverse landing" role="navigation">
            <div className="container">
              ...
              <div className="navbar-header">
                {' '}
                <a className="navbar-brand logocasa landing" href="javascript:void(0)">&nbsp;</a>
                {' '}
              </div>
        ...
        <div className="contenedor-banner-landing">
          <div className="banner-landing2" style={{ backgroundImage: 'http://tars.agency/gueno/galicia/images/banner-landing2.jpeg' }}>
        ...
        <div className="container landing">
          <div className="content landing">
            <div className="col-xs-12">
              <div className="row" style={{ marginBottom: '58px' }}>
                <div className="col-xs-12">
                ...
                <div className="row">
                  <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-no-line">
                    <div className="row margin-top-negative-50-desktop">
                      <div className="col-xs-12 col-sm-3 arriba" style={{ marginTop: 45 }}>
                        <div className="logoGalicia">&nbsp;</div>
                      </div>
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid #8f9299' }}>Monto crédito</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid #8f9299' }}>Período</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid rgba(21,28,41,.48)' }}>Cuota Mensual</p>
                      </div>
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2"><strong>$650.000</strong></p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">60 meses</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">$19.250</p>
                      </div>
                      <div className="col-xs-12 col-sm-3">
                        <a
                          type="button"
                          style={{
                            width: '100%', marginTop: 12, padding: '10px 24px', fontSize: 12,
                          }}
                          id="btn-submit"
                          className="btn btn-sm  margin-bottom-20"
                        >
Solicitar oferta
                      ...
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2"><strong>$350.000</strong></p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">36 meses</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">$17.017</p>
                      </div>
                      <div className="col-xs-12 col-sm-3">
                        <a
                          type="button"
...
Solicitar oferta
                      ...
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2"><strong>$200.000</strong></p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">24 meses</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">$14.584</p>
                      </div>
                      <div className="col-xs-12 col-sm-3">
                        <a
                          type="button"
...
Solicitar oferta
                      ...
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid #8f9299' }}>Tarjeta de crédito</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid #8f9299' }}>Cargo Anual</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid rgba(21,28,41,.48)' }}>TEA </p>
                      </div>
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2"><strong>$55.000</strong></p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">Bonificado 100%</p>
                        <p />

                      </div>
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2">98,44%</p>
                      </div>
                      <div className="col-xs-12 col-sm-3">
                        <a
                          type="button"
...
Solicitar oferta
                      ...
                      <div className="col-xs-12 col-sm-3 arriba" style={{ marginTop: 45 }}>
                        <div className="logoNaranja"><img src="http://tars.agency/gueno/galicia/images/logo-naranja.png" style={{ width: 140 }} /></div>
                      </div>
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p style={{ borderBottom: '1pt solid #8f9299' }}>Tarjeta de crédito</p>
                      ...
                      <div className="clearfix" />
                      <div className="col-xs-12 col-sm-3  arriba">
                        <p className="tabla2"><strong>$85.000</strong></p>
                        <p />
